...
namespace EmployeesManagment.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Employees.Include(e => e.Country).Include(e => e.County);
        ...
        public async Task<IActionResult> Create(Employee employee)
        {
            ...
            ViewData["CountyId"] = new SelectList(_context.Counties, "Id", "CountyName", employee.CountyId);
            return View(employee);
        }
